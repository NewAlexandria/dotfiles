...
ZSH_THEME_RANDOM_CANDIDATES=(  "agnoster" "ys" "avit" "clean" "bira" "robbyrussell" )
...
#fpath=(/completions $HOME/.oh-my-zsh/plugins/git $HOME/.oh-my-zsh/functions $HOME/.oh-my-zsh/completions /usr/local/share/zsh/site-functions /usr/share/zsh/site-functions /usr/share/zsh/5.8/functions)
